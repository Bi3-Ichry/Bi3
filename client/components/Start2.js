  ...
  return (
    ...
    <ScrollView  >
      ...
      <View style={styles.container}>
        <Text style={styles.fullname}>Quelle est votre date de naissance !

        </Text>
        <Text style={styles.name}>Choisir votre date de naissance .Vous pourrez à tout moment le rendre Privée par la suite.</Text>
