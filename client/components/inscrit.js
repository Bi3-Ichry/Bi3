  ...
  return (
    ...
    <ScrollView  >
      ...
      <View style={styles.container}>
        <Text style={styles.fullname}>Choisur un mot de passe  !

        </Text>
        <Text style={styles.name}>Choisir votre Mot de passe.Vous pourrez à tout moment le rendre Privée par la suite.</Text>
