  ...
  return (
    ...
    <ScrollView  >
      ...
      <View style={styles.container}>
        <Text style={styles.fullname}>Quelle est votre Numero de telephone !

        </Text>
        <Text style={styles.name}>Choisir votre Numero de telephone .Vous pourrez à tout moment le rendre Privée par la suite.</Text>
